		...
		<div class="container">
			<nav class="navbar navbar-default">
					<div class="navbar-header logo">
								...
								<h1>
									<a class="navbar-brand" href="dashboard_admin.php">Selamat Datang Admin !</a>
								</h1>
					</div>
					<div class="contact-bnr-w3-agile">
						<a class="page-scroll" href="index.php" data-toggle="modal" data-hover="LOGOUT">LOGOUT</a>
					</div>
					<!-- navbar-header -->
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="data_karyawan.php" class=" active">Data Karyawan</a></li>
							<li><a href="input_karyawan.php" class=" active">Input Daya Karyawan</a></li>
						</ul>
					</div>
...
<div class="portfolio w3layouts agileits" id="projects">
	<div class="container">
			<h3 class="heading-agileinfo">Billah Al-fath</h3><br><br>
			<h3 class="heading-agileinfo">12152052</h3>
...
<div class="copy">
	<div class="container">
		<p>© 2017 My Vacation . All Rights Reserved | Design by <a href="http://instagram.com/billah_alfath">Billah Al-fath</a></p>
...
<div class="blog" id="blog">
		<div class="container">
		<h3 class="heading-agileinfo">Blog Karyawan</h3>
								...
								<div class="agileits_w3layouts_banner_bottom_grid">
									<img src="images/3.jpg" alt=" " class="img-responsive" />
										<div class="Blog-info-agileits-w3layouts">
											...
											<p class="para-w3layouts">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis hendrerit lobortis elementum. </p>
											<div class="wthree_more wthree_more1">
												<a href="#" class="scroll" data-toggle="modal" data-target="index.php">Read More</a>
											</div>
										</div>
								</div>
							</li>
...
<div class="testimonials" id="testimonials">
	<div class="container">
					<h3 class="heading-agileinfo white">Bagaimana pendapat anda kerja di sini</h3>
			<div class="mis-stage"> 
				<ol class="mis-slider">
					<li class="mis-slide"> 
						...
						<figcaption>Asep Sumardi<span>Sed maximus eros quis leo congue ipsum sagittis.</span></figcaption>
						</figure>
						</a> </li>
					<li class="mis-slide"> <a href="#" class="mis-container">
						<figure>
						<img src="images/7.jpg" alt=" " class="img-responsive" />
						<figcaption>Udin Nganga<span>Sed maximus eros quis leo congue ipsum sagittis.</span></figcaption>
						</figure>
						</a> </li>
					<li class="mis-slide"> <a href="#" class="mis-container">
						<figure> 
						<img src="images/20.jpg" alt=" " class="img-responsive" />
						<figcaption>Steven J<span>Sed maximus eros quis leo congue ipsum sagittis.</span></figcaption>
						</figure>
						</a> </li>
					<li class="mis-slide"> <a href="#" class="mis-container">
						<figure> 
						<img src="images/18.jpg" alt=" " class="img-responsive" />
						<figcaption>Mansur Tea<span>Sed maximus eros quis leo congue ipsum sagittis.</span></figcaption>
						</figure>
						</a> </li>
					<li class="mis-slide"> <a href="#" class="mis-container">
						<figure> 
						<img src="images/t2.jpg" alt=" " class="img-responsive" />
						<figcaption>Boim<span>Sed maximus eros quis leo congue ipsum sagittis.</span></figcaption>
						</figure>
						</a> </li>
					<li class="mis-slide"> <a href="#" class="mis-container">
						<figure> 
						<img src="images/19.jpg" alt=" " class="img-responsive" />
						<figcaption>Giovanni<span>Sed maximus eros quis leo congue ipsum sagittis.</span></figcaption>
						</figure>
						</a> </li>
				</ol>
			</div>
